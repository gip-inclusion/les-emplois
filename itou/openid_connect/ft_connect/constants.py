...
FRANCETRAVAIL_CONNECT_SCOPES = " ".join(PE_BASIC_SCOPES + PE_EXTRA_SCOPES)

FRANCETRAVAIL_CONNECT_DISCOVERY = (
    settings.FRANCETRAVAIL_CONNECT_AUTH_BASE_URL
    + "/connexion/oauth2/.well-known/openid-configuration?realm=%2Findividu"
)
FRANCETRAVAIL_CONNECT_ENDPOINT_AUTHORIZE = f"{settings.FRANCETRAVAIL_CONNECT_AUTH_BASE_URL}/connexion/oauth2/authorize"
FRANCETRAVAIL_CONNECT_ENDPOINT_TOKEN = f"{settings.FRANCETRAVAIL_CONNECT_AUTH_BASE_URL}/connexion/oauth2/access_token"
FRANCETRAVAIL_CONNECT_ENDPOINT_USERINFO = f"{settings.API_ESD['BASE_URL']}/peconnect-individu/v1/userinfo"
FRANCETRAVAIL_CONNECT_ENDPOINT_LOGOUT = f"{settings.FRANCETRAVAIL_CONNECT_AUTH_BASE_URL}/compte/deconnexion"
FRANCETRAVAIL_CONNECT_ENDPOINT_JWKS = (
    f"{settings.FRANCETRAVAIL_CONNECT_AUTH_BASE_URL}/connexion/oauth2/connect/jwk_uri"
)

FRANCETRAVAIL_CONNECT_SESSION_TOKEN = "PE_ID_TOKEN"
