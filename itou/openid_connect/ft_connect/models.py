...
class FranceTravailConnectState(OIDConnectState):
    pass


@dataclasses.dataclass
class FranceTravailConnectUserData(OIDConnectUserData):
    ...
    def user_info_mapping_dict(user_info: dict):
        ...
        attrs = super(FranceTravailConnectUserData, FranceTravailConnectUserData).user_info_mapping_dict(
            user_info=user_info
        )
