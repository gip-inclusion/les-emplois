...
# https://docs.partenaires.franceconnect.gouv.fr/fi/general/donnees-utilisateur/
FRANCE_CONNECT_SCOPES = "openid gender given_name family_name email birthdate preferred_username"
...
FRANCE_CONNECT_ENDPOINT_LOGOUT = f"{settings.FRANCE_CONNECT_BASE_URL}/session/end"
