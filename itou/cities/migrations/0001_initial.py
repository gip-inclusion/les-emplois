# Generated by Django 2.2.4 on 2019-08-21 14:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='city',
            index=django.contrib.postgres.indexes.GinIndex(fields=['name'], name='cities_city_name_gin_trgm', opclasses=['gin_trgm_ops']),
        ),
    ]
