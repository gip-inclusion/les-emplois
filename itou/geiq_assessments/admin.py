    ...
    def download_label_infos(self, request, queryset):
        for campaign in queryset.select_related("label_infos"):
            ...
            try:
                ...
                messages.error(request, f"Erreur lors de la synchronisation de la campagne {campaign.year} avec label")

            else:
                messages.success(request, f"Les informations label de la campagne {campaign.year} ont été récupérées.")
