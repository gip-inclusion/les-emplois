...
./manage.py dumpdata companies.company > "$FIXTURES_DIRECTORY/10_companies.json"
./manage.py dumpdata companies.siaeconvention > "$FIXTURES_DIRECTORY/11_siae_conventions.json"
./manage.py dumpdata companies.siaefinancialannex > "$FIXTURES_DIRECTORY/12_siae_financial_annexes.json"
./manage.py dumpdata companies.companymembership > "$FIXTURES_DIRECTORY/13_company_memberships.json"
