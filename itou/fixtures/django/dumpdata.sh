...
./manage.py dumpdata gps.followupgroup -o "$FIXTURES_DIRECTORY/26_follow_up_groups.json"
./manage.py dumpdata gps.followupgroupmembership -o "$FIXTURES_DIRECTORY/27_follow_up_group_memberships.json"
