...
class Command(BaseCommand):
    ...
    @transaction.atomic
    def archive_cancelled_approvals(self):
    ...
    def handle(self, *args, wet_run, **options):
        ...
        self.logger.info("Start anonymizing cancelled approvals in %s mode", "wet_run" if wet_run else "dry_run")

        self.archive_cancelled_approvals()
