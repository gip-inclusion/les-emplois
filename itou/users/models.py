...
class User(AbstractUser, AddressMixin, AbstractFieldsHistoryModel):
    ...
    terms_accepted_at = models.DateTimeField(
        editable=False,
        verbose_name="date de dernière acceptation des CGU",
        null=True,
        blank=True,
    )
        ...
        constraints = [
            ...
            models.CheckConstraint(
                condition=(
                    ...
                    | Q(birth_country__isnull=False, birth_country=Country.FRANCE_ID, birth_place__isnull=False)
                    | Q(
                        ~Q(birth_country__isnull=False, birth_country=Country.FRANCE_ID),
...
class JobSeekerAssignment(models.Model):
    ...
    def organization(self):
        return self.company or self.prescriber_organization
    ...
    def is_still_member(self):
        # Overrite obj._is_still_member in objects list to avoid 1+N queries
        pass
