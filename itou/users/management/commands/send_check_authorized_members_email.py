...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        companies_members_url = reverse("companies_views:members")
        ...
        prescriber_organizations_members_url = reverse("prescribers_views:members")
        ...
        institutions_members_url = reverse("institutions_views:members")
