...
def get_permissions_dict():
    ...
    import itou.otp.models as otp_models
    ...
    group_itou_admin_permissions = {
        ...
        insertion_models.Orientation: PERMS_EDIT,
        insertion_models.OrientationProcessLink: PERMS_ADD | PERMS_DELETE,
        ...
        otp_models.ResetRequest: PERMS_EDIT,
