# Generated by Django 3.0.4 on 2020-03-19 10:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [("users", "0004_user_lack_of_pole_emploi_id_reason")]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name="user", name="city", field=models.CharField(blank=True, max_length=255, verbose_name="Ville")
        ),
        migrations.AddField(
            model_name="user",
            name="coords",
        ...
        migrations.AddField(
            ...
            field=models.FloatField(blank=True, null=True, verbose_name="Score du geocoding"),
        ),
        migrations.AddField(
            model_name="user",
            name="post_code",
