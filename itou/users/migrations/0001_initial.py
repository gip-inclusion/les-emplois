            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Indiquez la raison de l'absence d'identifiant France Travail.<br>Renseigner l'identifiant France Travail des candidats inscrits permet d'instruire instantanément votre demande.<br>Dans le cas contraire un délai de deux jours est nécessaire pour effectuer manuellement les vérifications d’usage.",
                        max_length=30,
