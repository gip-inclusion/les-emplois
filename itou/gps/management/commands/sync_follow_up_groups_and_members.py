...
def get_users_contacts(ids):
    beneficiaries_qs = (
        ...
        .annotate(
            job_apps_senders=ArraySubquery(
                ...
                .filter(sender__kind__in=UserKind.actors())
        ...
        .annotate(
            job_app_accepted_by=ArraySubquery(
                ...
                .filter(user__kind__in=UserKind.actors())
    ...
    for beneficiary in beneficiaries_qs:
        ...
        if beneficiary.created_by and beneficiary.created_by.kind in UserKind.actors():
