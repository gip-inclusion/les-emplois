...
from itou.inclusion_connect.models import InclusionConnectState, InclusionConnectUser
...
class InclusionConnectModelTest(TestCase):
    ...
    def test_create_user_from_user_info(self):
        ...
        but with more tests.
        """
        ic_user_data = InclusionConnectUser.from_user_info_dict(OIDC_USERINFO)
    ...
    def test_update_user_from_user_info(self):
        user = UserFactory(**dataclasses.asdict(InclusionConnectUser.from_user_info_dict(OIDC_USERINFO)))
        ic_user = InclusionConnectUser.from_user_info_dict(OIDC_USERINFO)
        ...
        new_ic_user = InclusionConnectUser(
