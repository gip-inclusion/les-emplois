...
class JobSeekerNIRUpdateMixin:
    ...
    def __init__(self, *args, editor=None, nir_modification_form_query=None, **kwargs):
        ...
        nir_modification_request_url = reverse(
            "job_seekers_views:nir_modification_request", kwargs={"public_id": job_seeker.public_id}
        )
        if nir_modification_form_query is not None:
            nir_modification_request_url += f"?{nir_modification_form_query}"
