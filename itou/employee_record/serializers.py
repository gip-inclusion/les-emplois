...
class _EmployeeRecordSerializer(serializers.ModelSerializer):
...
# WIP : Rework of serializer + tests, will replace old ones
...
class _PersonSerializer(serializers.Serializer):
    """
    Serializer of `personnePhysique` target field.
    """
...
class _AddressSerializer(serializers.Serializer):
    """
    Serializer of `adresse` target field.
    """
...
class EmployeeRecordBatchSerializer(serializers.Serializer):
    """
    This serializer is a wrapper for a list of employee records or notifications.
    """
