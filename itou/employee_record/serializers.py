...
class _SituationSerializer(serializers.Serializer):
    ...
    salarieSortantASE = serializers.BooleanField(
        source="job_application.job_seeker.jobseeker_profile.ase_exit"
    )  # Required
    salarieParentIsole = serializers.BooleanField(
        source="job_application.job_seeker.jobseeker_profile.isolated_parent"
    )  # Required
    salarieHebergement = serializers.BooleanField(
        source="job_application.job_seeker.jobseeker_profile.housing_issue"
    )  # Required
    salarieRefugie = serializers.BooleanField(
        source="job_application.job_seeker.jobseeker_profile.refugee"
    )  # Required
