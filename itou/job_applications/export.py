...
JOB_APPLICATION_XSLX_FORMAT = {
    ...
    "Éligibilité IAE validée": Format.TEXT,  # FIXME(alaurent) Try with a boolean instead
    "Eligible au contrôle": Format.TEXT,  # FIXME(alaurent) Try with a boolean instead
...
def _serialize_job_application(job_application, request):
    ...
    return [
        ...
        job_application.created_at.date(),
