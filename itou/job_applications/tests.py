...
class JobApplicationCsvExportTest(TestCase):
    ...
    def test_csv_export_contains_the_necessary_info(self):
        ...
        self.assertIn("Demandeur d'emploi", csv_output.getvalue())
        self.assertIn(f"{job_seeker.first_name} {job_seeker.last_name}", csv_output.getvalue())
        self.assertIn("Orienteur", csv_output.getvalue())
