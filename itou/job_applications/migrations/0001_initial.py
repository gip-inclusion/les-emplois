        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(default=False, verbose_name="PASS\xa0IAE envoyé par email"),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        max_length=30,
                        verbose_name="mode d'attribution du PASS\xa0IAE",
                    ),
                ),
                (
                    "approval_number_sent_at",
                    models.DateTimeField(
                        blank=True, db_index=True, null=True, verbose_name="date d'envoi du PASS\xa0IAE"
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="PASS\xa0IAE délivré manuellement par",
                    ),
                ),
                (
                    "approval_manually_refused_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="date de refus manuel du PASS\xa0IAE"),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="PASS\xa0IAE refusé manuellement par",
                    ),
                ),
                (
                ...
                (
                    "archived_at",
                    models.DateTimeField(blank=True, db_index=True, null=True, verbose_name="archivée le"),
                ),
                (
                    "archived_by",
                    models.ForeignKey(
                ...
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(
                            ...
                            models.Q(
                                ("contract_type", ""), ("contract_type_details", ""), ("nb_hours_per_week", None)
                            ),
                            _connector="OR",
                        ),
                    ...
                    models.CheckConstraint(
                        ...
                        violation_error_message="Une candidature ne peut avoir les deux types de diagnostics (IAE et "
                        "GEIQ)",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ("qualification_level", "NOT_RELEVANT"),
                            ("qualification_type", "STATE_DIPLOMA"),
                            _negated=True,
                        ),
                        name="qualification_coherence",
                        violation_error_message="Incohérence dans les champs concernant la qualification pour le "
                        "contrat GEIQ",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ...
                            models.Q(
                                models.Q(
                                    ("state__in", ["accepted", "refused", "cancelled", "obsolete"]), _negated=True
                                ),
                                ("processed_at", None),
                            ),
                            _connector="OR",
                    ...
                    models.CheckConstraint(
                        ...
                        violation_error_message="Impossible d’archiver une candidature acceptée ou en action "
                    ...
                    models.CheckConstraint(
                        ...
                        violation_error_message="Une candidature active ne peut pas avoir été archivée par un "
                        "utilisateur.",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
