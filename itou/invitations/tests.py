...
class InvitationModelTest(TestCase):
    ...
    def test_get_model_from_string(self):
        invitation_type = InvitationWrapper.get_model_from_string("siae_staff")
        self.assertEqual(invitation_type, SiaeStaffInvitation)

        with self.assertRaises(TypeError):
            InvitationWrapper.get_model_from_string("wrong_type")

        with self.assertRaises(TypeError):
            InvitationWrapper.get_model_from_string(12)
