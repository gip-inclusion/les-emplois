...
def test_matomo_populate_private(monkeypatch, respx_mock):
    ...
    with connection.cursor() as cursor:
        ...
        assert [line[-5:] for line in rows] == [
            ...
            ("2022-06-13", "tb 160 - Facilitation de l'embauche DREETS/DDETS IAE", None, None, "Bretagne"),
            ...
            ("2022-06-13", "tb 265 - Suivi CAP DREETS/DDETS IAE", None, None, "Bretagne"),
            ("2022-06-13", "tb 267 - Focus auto-prescription DREETS/DDETS IAE", None, None, "Bretagne"),
            ...
            (
                "2022-06-13",
                "tb 160 - Facilitation de l'embauche DREETS/DDETS IAE",
                "31 - Haute-Garonne",
                "31",
                "Occitanie",
            ),
            ...
            ("2022-06-13", "tb 265 - Suivi CAP DREETS/DDETS IAE", "31 - Haute-Garonne", "31", "Occitanie"),
            (
                "2022-06-13",
                "tb 267 - Focus auto-prescription DREETS/DDETS IAE",
                "31 - Haute-Garonne",
                "31",
                "Occitanie",
            ),
            ...
            ("2022-06-13", "tb 265 - Suivi CAP DREETS/DDETS IAE", "75 - Paris", "75", "Île-de-France"),
            ("2022-06-13", "tb 267 - Focus auto-prescription DREETS/DDETS IAE", "75 - Paris", "75", "Île-de-France"),
        ]
