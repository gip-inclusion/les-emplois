...
PRIVATE_DEPARTMENT_DASHBOARDS = {
    ...
    "stats/ddets/auto_prescription/{}": "tb 267 - Focus auto-prescription DREETS/DDETS IAE",
    "stats/ddets/follow_siae_evaluation/{}": "tb 265 - Suivi CAP DREETS/DDETS IAE",
    "stats/ddets/hiring/{}": "tb 160 - Facilitation de l'embauche DREETS/DDETS IAE",
...
PRIVATE_REGION_DASHBOARDS = {
    "stats/dreets/auto_prescription/{}": "tb 267 - Focus auto-prescription DREETS/DDETS IAE",
    "stats/dreets/follow_siae_evaluation/{}": "tb 265 - Suivi CAP DREETS/DDETS IAE",
    "stats/dreets/hiring/{}": "tb 160 - Facilitation de l'embauche DREETS/DDETS IAE",
