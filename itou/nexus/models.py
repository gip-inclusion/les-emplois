...
class User(models.Model):
    ...
    kind = models.CharField(verbose_name="Type d'utilisateur", choices=UserKind.choices, blank=True)
...
class Structure(AddressMixin, models.Model):
    ...
    kind = models.CharField(verbose_name="type", choices=StructureKind.choices)
    email = CIEmailField("adresse e-mail", db_index=True)
    phone = models.CharField(verbose_name="téléphone", max_length=20, blank=True)
