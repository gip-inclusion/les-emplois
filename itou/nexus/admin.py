...
class NexusAdminMixin:
    ...
    def get_object(self, request, object_id, from_field=None):
        ...
        obj.threshold = getattr(
            NexusRessourceSyncStatus.objects.filter(service=obj.source).first(), "timestamp", DEFAULT_VALID_SINCE
        )
        return obj
...
class NexusRessourceSyncStatusAdmin(ItouModelAdmin):
    list_display = ("service", "valid_since", "new_start_at")
