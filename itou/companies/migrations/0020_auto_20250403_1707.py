...
def set_last_employer_update_at(apps, schema_editor):
    ...
    job_description_qs = (
        apps.get_model("companies", "JobDescription")
        .objects.annotate(is_siae_active=Exists(subquery))
        .filter(is_active=True, is_siae_active=True)
    )
...
class Migration(migrations.Migration):
    dependencies = [
        ("companies", "0019_jobdescription_last_employer_update_at"),
    ]
