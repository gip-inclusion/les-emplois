...
DIRECT_MODEL_FIELDS = [
    transfer.TransferField.BRAND,
    transfer.TransferField.DESCRIPTION,
    transfer.TransferField.PHONE,
]
        ...
        **options,
        ...
        if only_job_applications:
            ...
            fields_to_transfer = [
                ...
                if transfer_field not in DIRECT_MODEL_FIELDS
            ]
        else:
        ...
        try:
            with transaction.atomic():
                ...
                for section, section_changes in reporter.changes.items():
                    if section in DIRECT_MODEL_FIELDS:
                        self.stdout.write(
