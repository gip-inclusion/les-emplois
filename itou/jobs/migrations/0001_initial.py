...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Job',
            fields=[
                ('code_rome', models.CharField(max_length=5, primary_key=True, serialize=False, verbose_name='Code ROME')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, max_length=256, verbose_name='Nom')),
                ('short_name', models.CharField(db_index=True, max_length=256, verbose_name='Nom court')),
                ('job', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='appellations', to='jobs.Job')),
            ],
            options={
