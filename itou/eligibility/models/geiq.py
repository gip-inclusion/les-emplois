...
class GEIQEligibilityDiagnosisQuerySet(CommonEligibilityDiagnosisQuerySet):
    ...
    def valid_diagnoses_for(self, job_seeker, for_geiq=None, for_job_seeker=False):
        ...
        # from a specified GEIQ.
        return self.valid().diagnoses_for(job_seeker, for_geiq, for_job_seeker)
