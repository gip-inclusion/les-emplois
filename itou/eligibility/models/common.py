...
from itou.eligibility.tasks import async_certify_criterion_by_api_particulier
...
class AbstractSelectedAdministrativeCriteria(models.Model):
    ...
    last_certification_attempt_at = models.DateTimeField(
        blank=True,
        null=True,
        editable=False,
        verbose_name="dernière tentative de certification",
    )
    created_at = models.DateTimeField(verbose_name="date de création", default=timezone.now)
