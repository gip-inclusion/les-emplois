...
class EligibilityDiagnosisManager(models.Manager):
    ...
    def last_for_job_seeker(self, job_seeker, prefetch=None):
        """
        ...
        either from an authorized prescriber or from an employer, if the diagnosis lead
        to an approval
          - an expired diagnosis if there is one and no valid diagnoses
        """
