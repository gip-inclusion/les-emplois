...
class Command(BaseCommand):
    ...
    def handle(self, *, wet_run, limit, **options):
        ...
        max_created_at = timezone.now() - datetime.timedelta(Orientation.PENDING_EXPIRATION_PERIOD_DAYS)
        ...
        orientations = (
            ...
            )  # avoid sending reminders indefinitely if an orientation failed to be expired
            .select_related(
                "service",
                "beneficiary",
                "sender",
