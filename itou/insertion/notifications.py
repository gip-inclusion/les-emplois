...
class NewOrientationForBeneficiary(JobSeekerNotification, EmailNotification):
...
@notifications_registry.register
class NewOrientationForSender(ProfessionalNotification, EmailNotification):
...
@notifications_registry.register
class ProcessingOrientationForBeneficiary(JobSeekerNotification, EmailNotification):
...
@notifications_registry.register
class ProcessingOrientationForSender(ProfessionalNotification, EmailNotification):
...
@notifications_registry.register
class AcceptedOrientationForBeneficiary(JobSeekerNotification, EmailNotification):
...
@notifications_registry.register
class AcceptedOrientationForSender(ProfessionalNotification, EmailNotification):
...
@notifications_registry.register
class RefusedOrientationForBeneficiary(JobSeekerNotification, EmailNotification):
...
@notifications_registry.register
class RefusedOrientationForSender(ProfessionalNotification, EmailNotification):
