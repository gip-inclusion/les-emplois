...
def set_refusal_reason_for_refused_orientation(apps, schema_editor):
    ...
    for orientation in refused_orientations:
        ...
        # this information is not shown, it is only for statistics, and concerns ~10 orientations
        orientation.refusal_details = "N/A"
        to_update.append(orientation)

    Orientation.objects.bulk_update(to_update, fields=["refusal_reasons", "refusal_details"])
    print("\n")
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    models.Q(
                        ...
                        models.Q(("refusal_details", ""), _negated=True),
                    ),
                    models.Q(
