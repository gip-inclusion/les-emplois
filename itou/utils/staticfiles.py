...
ASSET_INFOS = {
    ...
    "theme-inclusion": {
        "download": {
            "url": "https://github.com/gip-inclusion/itou-theme/archive/refs/tags/v3.4.5.zip",
            "sha256": "207b1b17a919013654432a0231460d67109817f62c5914e6a8345f1b2d935c87",
        },
        "extract": {
            "origin": "itou-theme-3.4.5/dist",
