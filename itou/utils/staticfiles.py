...
ASSET_INFOS = {
    ...
    "theme-inclusion": {
        "download": {
            "url": "https://github.com/gip-inclusion/itou-theme/archive/refs/tags/v2.8.8.zip",
            "sha256": "9bd899e75e4cd81c7a2e6d893bc2e516306f26651da5fb6a2baed1800ba7275d",
        },
        "extract": {
            "origin": "itou-theme-2.8.8/dist",
