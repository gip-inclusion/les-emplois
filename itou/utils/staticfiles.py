...
ASSET_INFOS = {
    ...
    "theme-inclusion": {
        "download": {
            "url": "https://github.com/gip-inclusion/itou-theme/archive/refs/tags/v3.2.9.zip",
            "sha256": "449dae858e968cdf57ea54d45bcafb8e6c6ee98254d575a8efa0d719f8ea52a1",
        },
        "extract": {
            "origin": "itou-theme-3.2.9/dist",
