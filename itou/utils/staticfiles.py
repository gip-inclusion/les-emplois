...
ASSET_INFOS = {
    ...
    "theme-inclusion": {
        "download": {
            "url": "https://github.com/gip-inclusion/itou-theme/archive/refs/tags/v2.1.9.zip",
            "sha256": "9b8efe897c2eebe96c69f5d5d9862216ae9b1482119c7250443326210f5ebabf",
        },
        "extract": {
            "origin": "itou-theme-2.1.9/dist",
