...
ASSET_INFOS = {
    ...
    "theme-inclusion": {
        "download": {
            "url": "https://github.com/gip-inclusion/itou-theme/archive/refs/tags/v2.0.6.zip",
            "sha256": "538f343e480e7d73964e760793da634779a8546d3a1db86d45753375edc1029c",
        },
        "extract": {
            "origin": "itou-theme-2.0.6/dist",
