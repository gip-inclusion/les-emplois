...
ASSET_INFOS = {
    ...
    "theme-inclusion": {
        "download": {
            "url": "https://github.com/gip-inclusion/itou-theme/archive/refs/tags/v1.5.1.zip",
            "sha256": "f470fa8b770f12520621a51de19874ee3e776515e98ee2cdbf7668e10ce601ec",
        },
        "extract": {
            "origin": "itou-theme-1.5.1/dist",
