...
ASSET_INFOS = {
    ...
    "theme-inclusion": {
        "download": {
            "url": "https://github.com/gip-inclusion/itou-theme/archive/refs/tags/v2.8.5.zip",
            "sha256": "58c7177d6d23f3bae2e92235554e7cff84a4fa8636201b1dfbe70b402dcfc7e3",
        },
        "extract": {
            "origin": "itou-theme-2.8.5/dist",
