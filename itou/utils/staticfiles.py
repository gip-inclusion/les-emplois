...
ASSET_INFOS = {
    ...
    "theme-inclusion": {
        "download": {
            "url": "https://github.com/gip-inclusion/itou-theme/archive/refs/tags/v3.0.7.zip",
            "sha256": "27e754d16364af43e270eb8ca70493fe6ebfc9319bc59cc3e5f5a1b27c5cad18",
        },
        "extract": {
            "origin": "itou-theme-3.0.7/dist",
