...
ASSET_INFOS = {
    ...
    "theme-inclusion": {
        "download": {
            "url": "https://github.com/gip-inclusion/itou-theme/archive/refs/tags/v3.3.7.zip",
            "sha256": "9d24b14458d05cf9a324c1d9190d6acea810dd1e46679a4b45b98fc5c2e17c25",
        },
        "extract": {
            "origin": "itou-theme-3.3.7/dist",
