...
class PoleEmploiRoyaumeAgentAPIClient(BasePoleEmploiApiClient):
    ...
    def _rechercher_usager_by_pole_emploi_id(self, pole_emploi_id):
        ...
        return self._request(
            f"{self.base_url}{ENDPOINTS['rechercher-usager-numero-france-travail']}",
            {
    ...
    def _rechercher_usager_by_birthdate_and_nir(self, birthdate, nir):
        ...
        return self._request(
            f"{self.base_url}{ENDPOINTS['rechercher-usager-date-naissance-nir']}",
            {
    ...
    def certify_rqth(self, jobseeker_profile):
        ...
        data = self._request(
            f"{self.base_url}{ENDPOINTS['rqth']}", method="GET", additional_headers={"ft-jeton-usager": jeton_usager}
        )
