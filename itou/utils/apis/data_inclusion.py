...
class DataInclusionApiV0Client:
    ...
    def search_services(self, code_insee: str) -> list[dict]:
        params = {
            ...
            "thematiques": [
                v0.Thematique.ACCES_AUX_DROITS_ET_CITOYENNETE,
                v0.Thematique.EQUIPEMENT_ET_ALIMENTATION,
                v0.Thematique.LOGEMENT_HEBERGEMENT,
                v0.Thematique.MOBILITE,
                v0.Thematique.REMOBILISATION,
            ],
