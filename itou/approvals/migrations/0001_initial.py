    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            ("S022", "SD non installé : Refus du PASS\xa0IAE"),
                            ("S023", "SD non installé : Date de début du PASS\xa0IAE obligatoire"),
                            ("S024", "SD non installé : Date de début du PASS\xa0IAE dans le futur"),
                            ("S025", "SD non installé : Date de fin du PASS\xa0IAE obligatoire"),
                            ("S026", "SD non installé : Date fin PASS\xa0IAE non strictement sup à date début"),
                            ("S027", "SD non installé : Numéro du PASS\xa0IAE obligatoire"),
                ...
                (
                    "origin_siae_siret",
                    models.CharField(max_length=14, null=True, verbose_name="siret siae à l'origine du PASS\xa0IAE"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("pole_emploi_id", models.CharField(max_length=8, verbose_name="identifiant France Travail")),
        ...
        migrations.CreateModel(
            ...
            options={
                "verbose_name": "PASS\xa0IAE annulé",
                "verbose_name_plural": "PASS\xa0IAE annulés",
                "ordering": ["-created_at"],
            },
        ),
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                ...
                violation_error_message="Incohérence entre l'origine du PASS\xa0IAE et la présence d'un diagnostic "
                "d'éligibilité",
            ),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                ...
                violation_error_message="Une demande de prolongation à traiter existe déjà pour ce PASS\xa0IAE",
            ),
        ),
