...
from itou.communications.dispatch import EmailNotification, JobSeekerNotification, ProfessionalNotification
...
class ProlongationRequestCreatedForProfessionalNotification(ProfessionalNotification, EmailNotification):
...
@notifications_registry.register
class ProlongationRequestCreatedReminderForProfessionalNotification(ProfessionalNotification, EmailNotification):
...
@notifications_registry.register
class ProlongationRequestDeniedForProfessionalNotification(ProfessionalNotification, EmailNotification):
...
@notifications_registry.register
class PassAcceptedProfessionalNotification(ProfessionalNotification, EmailNotification):
...
@notifications_registry.register
class ProlongationRequestGrantedForProfessionalNotification(ProfessionalNotification, EmailNotification):
