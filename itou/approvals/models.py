...
class Approval(PENotificationMixin, CommonApprovalMixin):
    ...
    ERROR_PASS_IAE_SUSPENDED_FOR_PROXY = (
        "Le PASS IAE de l’usager est suspendu. Vous ne pouvez pas postuler pour lui pendant la période de suspension."
    )
    ...
    def delete(self, *args, **kwargs):
        CancelledApproval(
            ...
            origin_siae_siret=self.origin_siae_siret,
            origin_siae_kind=self.origin_siae_kind,
            origin_sender_kind=self.origin_sender_kind,
            origin_prescriber_organization_kind=self.origin_prescriber_organization_kind,
        ).save()
