...
class ProlongationRequest(CommonProlongation):
    ...
    def notify_authorized_prescriber(self):
        notifications.ProlongationRequestCreatedForCaseworkerNotification(
    ...
    def grant(self, user):
        ...
        notifications.ProlongationRequestGrantedForCaseworkerNotification(
            self.declared_by,
    ...
    def deny(self, user, information):
        ...
        notifications.ProlongationRequestDeniedForCaseworkerNotification(
