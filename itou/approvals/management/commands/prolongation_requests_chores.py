...
from itou.approvals.notifications import ProlongationRequestCreatedReminderForCaseworkerNotification
...
class Command(BaseCommand):
    ...
    def send_reminder_to_prescriber_organization_other_members(self):
        ...
        for prolongation_request in queryset:
            ProlongationRequestCreatedReminderForCaseworkerNotification(
