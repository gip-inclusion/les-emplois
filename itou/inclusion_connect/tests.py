...
from itou.users.factories import DEFAULT_PASSWORD, PrescriberFactory, SiaeStaffFactory, UserFactory
...
from .models import InclusionConnectUser
...
class InclusionConnectLoginTest(TestCase):
    ...
    def test_old_django_account(self):
        ...
        user = PrescriberFactory(
            ...
            **dataclasses.asdict(InclusionConnectUser.from_user_info_dict(user_info)),
        )
