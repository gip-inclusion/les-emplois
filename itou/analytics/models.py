...
class DatumCode(models.TextChoices):
    ...
    # Users
    USER_COUNT = "US-101", "Nombre d'utilisateurs"
    USER_JOB_SEEKER_COUNT = "US-111", "Nombre de demandeurs d'emploi"
    USER_PRESCRIBER_COUNT = "US-112", "Nombre de prescripteurs"
    USER_EMPLOYER_COUNT = "US-113", "Nombre d'employeurs"
    USER_LABOR_INSPECTOR_COUNT = "US-114", "Nombre d'inspecteurs du travail"
    USER_ITOU_STAFF_COUNT = "US-115", "Nombre d'administrateurs"
    # Old Users stats
    OLD_USER_COUNT = "US-001", "Nombre d'utilisateurs (ancien calcul)"
    OLD_USER_JOB_SEEKER_COUNT = "US-011", "Nombre de demandeurs d'emploi (ancien calcul)"
    OLD_USER_PRESCRIBER_COUNT = "US-012", "Nombre de prescripteurs (ancien calcul)"
    OLD_USER_EMPLOYER_COUNT = "US-013", "Nombre d'employeurs (ancien calcul)"
    OLD_USER_LABOR_INSPECTOR_COUNT = "US-014", "Nombre d'inspecteurs du travail (ancien calcul)"
    OLD_USER_ITOU_STAFF_COUNT = "US-015", "Nombre d'administrateurs (ancien calcul)"
    # API usage
    ...
    API_TOTAL_CALLS_JOB_APP_SEARCH = "API-013", "API candidatures : total d'appels reçus"
    API_TOTAL_UT_JOB_APP_SEARCH = "API-014", "API candidatures : total de jetons uniques"
    # Tech metrics
