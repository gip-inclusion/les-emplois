        ...
        migrations.AlterField(
            ...
            field=models.TextField(
                choices=[
                    ...
                    ("US-101", "Nombre d'utilisateurs"),
                    ("US-111", "Nombre de demandeurs d'emploi"),
                    ("US-112", "Nombre de prescripteurs"),
                    ("US-113", "Nombre d'employeurs"),
                    ("US-114", "Nombre d'inspecteurs du travail"),
                    ("US-115", "Nombre d'administrateurs"),
                    ("US-001", "Nombre d'utilisateurs (ancien calcul)"),
                    ("US-011", "Nombre de demandeurs d'emploi (ancien calcul)"),
                    ("US-012", "Nombre de prescripteurs (ancien calcul)"),
                    ("US-013", "Nombre d'employeurs (ancien calcul)"),
                    ("US-014", "Nombre d'inspecteurs du travail (ancien calcul)"),
                    ("US-015", "Nombre d'administrateurs (ancien calcul)"),
