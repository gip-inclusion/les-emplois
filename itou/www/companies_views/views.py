        ...
        match request.POST.get("action"):
            ...
            case "toggle_spontaneous_applications":
                ...
                if company.block_job_applications:
                    ...
                    content = (
                        f"Les candidatures spontanées sont maintenant {'activées' if set_active else 'désactivées'}"
                    )
                    if set_active:
                        messages.success(request, content, extra_tags="toast")
                    else:
                        messages.warning(request, content, extra_tags="toast")
