        ...
        match request.POST.get("action"):
            ...
            case "toggle_spontaneous_applications":
                ...
                if company.block_job_applications:
                    # NOTE: the form should be disabled so this shouldn't happen.
                    messages.warning(
                        request,
                        (
                    ...
                    content = "activées" if set_active else "désactivées"
                    messages.success(
                        request,
                        f"Les candidatures spontanées sont maintenant {content}",
                        extra_tags="toast",
                    )
