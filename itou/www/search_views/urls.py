...
urlpatterns = [
    ...
    path("employers", views.search_home, name="employers_home"),
    ...
    # Backward compatibility, landing pages for different kinds were separate.
    path("prescribers", views.search_home, name="prescribers_home"),
    path("prescribers/results", views.search_prescribers_results, name="prescribers_results"),
    # Backward compatibility, landing pages for different kinds were separate.
    path("services", views.search_home, name="services_home"),
