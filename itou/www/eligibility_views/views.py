...
class BaseIAEEligibilityViewForPrescriber(UserPassesTestMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        if not self.eligibility_diagnosis:
            ...
            message = f"L’éligibilité de l’usager {self.job_seeker.get_inverted_full_name()} a bien été validée."
            ...
            message = f"L’éligibilité de l’usager {self.job_seeker.get_inverted_full_name()} a bien été mise à jour."
