...
def create_step_3(request, job_application_id, template_name="employee_record/create.html"):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        if employee_record:
            if is_ntt_required(job_application.job_seeker.jobseeker_profile.nir) and (
                ...
                # Drop NTT from session after use
                del request.session[get_session_ntt_key(job_application)]
            return HttpResponseRedirect(
