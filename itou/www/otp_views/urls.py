...
urlpatterns = [
    ...
    path("reset-request/cancel", views.reset_request_self_cancel, name="reset_request_self_cancel"),
    path(
    ...
    path("reset-request/reset/<str:token>", views.reset_request_do_reset, name="reset_request_do_reset"),
]
