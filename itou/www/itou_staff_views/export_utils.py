...
job_app_export_spec = {
    ...
    "job_seeker_created_by": lambda job_app: _getattrs(job_app.job_seeker, "created_by", "pretty_display"),
    ...
    "sender": lambda job_app: _getattrs(job_app, "sender", "pretty_display"),
