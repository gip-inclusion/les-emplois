...
job_app_export_spec = {
    ...
    "job_seeker_birth_name": lambda job_app: job_app.job_seeker.jobseeker_profile.birth_name,
    ...
    "job_seeker_created_by": lambda job_app: _getattrs(job_app.job_seeker, "created_by", "display_with_pii"),
    ...
    "sender": lambda job_app: _getattrs(job_app, "sender", "display_with_pii"),
