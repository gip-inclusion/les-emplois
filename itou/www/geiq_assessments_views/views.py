...
def assessment_sync_file(request, pk, *, file_field):
    ...
    if not getattr(assessment, file_field):
        ...
        try:
            ...
            setattr(assessment, file_field, File.objects.create(id=key, key=key))
...
def upload_action_financial_assessment(
    ...
    if request.method == "POST" and form.is_valid():
        ...
        assessment.action_financial_assessment_file = File.objects.create(id=file_key, key=file_key)
