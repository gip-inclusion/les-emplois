...
def details_for_siae(request, job_application_id, template_name="apply/process_details.html"):
    ...
    cancellation_days_in_past = JobApplication.CANCELLATION_DAYS_BEFORE_HIRING_STARTED
    ...
    context = {
        ...
        "cancellation_days_in_past": cancellation_days_in_past,
    }
...
def cancel(request, job_application_id):
    ...
    if job_application.can_be_cancelled:
        ...
        messages.success(request, _("La candidature a bien été annulée."))
    else:
        messages.error(request, _("Vous ne pouvez pas annuler cette candidature."))
