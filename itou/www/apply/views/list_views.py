...
def list_for_siae_actions(request):
    ...
    can_unarchive = all(job_application.archived_at is not None for job_application in selected_job_applications)
    ...
    context = {
        ...
        "other_actions_count": sum([can_process, can_postpone, can_archive, can_transfer, can_unarchive]),
