            ...
            if not accept_no_criteria and criterion.written_proof:
                if self.fields[criterion.key].help_text:
                    self.fields[criterion.key].help_text += (
                        f'<span class="d-block mt-2"><strong>Pièce justificative :</strong> '
                        f"{criterion.written_proof}</span>"
                    )
                else:
                    self.fields[
                        criterion.key
                    ].help_text += f"<strong>Pièce justificative :</strong> {criterion.written_proof}"
