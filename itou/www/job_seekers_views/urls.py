...
urlpatterns = [
    ...
    path("check_nir/<uuid:session_uuid>", views.CreateJobSeekerCheckNIRView.as_view(), name="check_nir"),
    path("check_nir", views.CreateJobSeekerCheckNIRView.as_view(), name="check_nir"),
    path(
        "search-by-email/<uuid:session_uuid>",
        views.SearchByEmailView.as_view(),
        name="search_by_email",
    ),
    path(
        "create/<uuid:session_uuid>/1",
        views.CreateJobSeekerStep1View.as_view(),
        name="create_job_seeker_step_1_for_sender",
    ),
    path(
        "create/<uuid:session_uuid>/2",
        views.CreateJobSeekerStep2ForSenderView.as_view(),
        name="create_job_seeker_step_2_for_sender",
    ),
    path(
        "create/<uuid:session_uuid>/3",
        views.CreateJobSeekerStep3ForSenderView.as_view(),
        name="create_job_seeker_step_3_for_sender",
    ),
    path(
        "create/<uuid:session_uuid>/end",
