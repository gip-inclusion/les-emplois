...
class ApprovalBaseViewMixin:
    ...
    # FIXME(alaurent) remove this when creating a real model for employees
...
class ApprovalDetailView(ApprovalBaseViewMixin, LoginRequiredMixin, DetailView):
    model = Approval
...
def display_printable_approval(request, approval_id, template_name="approvals/printable_approval.html"):
    ...
    # FIXME(alaurent) We could probalby just use "if not siae.is_subject_to_eligibility_rules"
