...
class PEAMUTests(OAuth2TestsMixin, TestCase):
    ...
    def test_data_created_by_peamu_login(self):
    ...
    def test_peamu_connection_for_existing_non_peamu_user(self):
    ...
    def test_email_verification_is_skipped_for_peamu_account(self):
        test_email = "john.doe@example.com"
        self.login(self.get_mocked_response())
        email_address = EmailAddress.objects.get(email=test_email)
    ...
    def test_username_is_based_on_first_name(self):
        first_name = "jessica"
        last_name = "parker"
    ...
    def test_username_is_based_on_email_if_first_name_is_exotic(self):
        first_name = "明"
        last_name = "小"
        email = "john.doe@example.com"
        self.login(self.get_mocked_response(email=email, given_name=first_name, family_name=last_name))
