...
class ConfigureJobsViewTest(TestCase):
    ...
    def test_update(self):
        ...
        self.assertTrue(self.siae.jobs_through.get(appellation_id=10357, is_active=True))
        self.assertTrue(self.siae.jobs_through.get(appellation_id=10579, is_active=False))
        self.assertTrue(self.siae.jobs_through.get(appellation_id=10750, is_active=False))
        self.assertTrue(self.siae.jobs_through.get(appellation_id=10877, is_active=True))
        self.assertTrue(self.siae.jobs_through.get(appellation_id=16361, is_active=False))
