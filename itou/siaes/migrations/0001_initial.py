...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Siae',
            fields=[
                ('address_line_1', models.CharField(blank=True, max_length=255, verbose_name='Adresse postale, bôite postale')),
                ('address_line_2', models.CharField(blank=True, max_length=255, verbose_name='Appartement, suite, bloc, bâtiment, etc.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('siae', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jobs_through', to='siaes.Siae')),
            ],
            options={
                'ordering': ['ui_rank'],
        ...
        migrations.AddField(
            model_name='siae',
            name='jobs',
            field=models.ManyToManyField(blank=True, through='siaes.SiaeJobs', to='jobs.Appellation', verbose_name='Métiers'),
        ),
        migrations.AddField(
            model_name='siae',
            name='members',
