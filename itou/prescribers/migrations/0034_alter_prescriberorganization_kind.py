...
def move_data_forward(apps, schema_editor):
    ...
    PrescriberOrganization.objects.filter(kind="OTHER").update(kind="Autre")


class Migration(migrations.Migration):

    dependencies = [
        ("prescribers", "0033_alter_prescriberorganization_department"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    (
                        "OACAS",
                        "OACAS - Structure porteuse d'un agrément national organisme d'accueil "
                        "communautaire et d'activité solidaire",
                    ),
                    ("Autre", "Autre"),
                ],
                default="Autre",
