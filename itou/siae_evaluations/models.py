...
class ArchivedEvaluatedSiae(models.Model):
    ...
    reviewed_at = models.DateTimeField(verbose_name="contrôlée le", blank=True, null=True, editable=False)
    final_reviewed_at = models.DateTimeField(
        verbose_name="contrôle définitif le", blank=True, null=True, editable=False
    )
    final_state = models.CharField(
        verbose_name="état final après la cloture de la campagne d'évaluation",
        choices=evaluation_enums.EvaluatedSiaeFinalState.choices,
