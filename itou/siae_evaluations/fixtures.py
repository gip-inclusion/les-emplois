...
Employer's account: demo.emplois+cap@inclusion.gouv.fr
Labor inspector's account: demo.emplois+ddets@inclusion.gouv.fr
"""
...
NAMES = [
    ("Gustave", "Loiseau", "187104712403340", "3703059J"),
    ("Aristide", "Filoselle", "187103415217885", "3401486E"),
    ("Oliveria", "Da Figueira", "187102017128676", "3354471C"),
    ("Fan", "Se-Yeng", "187102531808302", "3145793B"),
    ("Archibald", "Haddock", "187107317012993", "3103819B"),
    ("Bianca", "Castafiore", "287103404102922", "350704F"),
    ("Mohammed", "Ben Kalish Ezab", "187105714612783", "3476261C"),
    ("Tryphon", "Tournesol", "187105012012584", "3321089E"),
    ("Bunji", "Kuraki", "187101300806442", "3298096C"),
    ("Roberto", "Rastapopoulos", "187107922316551", "3424548G"),
    ("Séraphin", "Lampion", "187104308500783", "3491405D"),
    ("Allan", "Thompson", "187101033733471", "3391055C"),
    ("Diego", "le Navarrais", "187101703338725", "3718757J"),
    ("Igor", "Wagner", "187107823832946", "3621359J"),
    ("Frank", "Wolff", "187106129833161", "3644055J"),
    ("Tristan", "Bior", "187106539602337", "3355357E"),
    ("Émile", "Vanneau", "187102117208427", "3354895F"),
    ("Jean-Loup", "de La Batellerie", "187109413107670", "3354895D"),
]
...
def load_data():
    ...
    employer = User.objects.get(email="demo.emplois+cap@inclusion.gouv.fr")
