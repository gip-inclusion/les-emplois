...
Si des modifications sont nécessaires, le bouton "Renvoyer à la DDETS pour correction" vous permettra de revenir à l’étape précédente, afin que la {{ assessment.reviewed_by_institution.name }} ou vous-même puissiez effectuer les ajustements requis.
