...
La candidature de {{ job_application.job_seeker.get_inverted_full_name|mask_unless:can_view_personal_information }} au sein de la structure {{ job_application.to_company.kind }} {{ job_application.to_company.display_name }} a été ajoutée dans le vivier de candidatures en vue de prochaines opportunités.
