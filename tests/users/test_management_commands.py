...
class TestSyncJobSeekerAssignmentManagementCommand:
    ...
    def test_sync_job_seeker_assignments(self):
        ...
        assignment_1_prescriber = JobSeekerAssignment.objects.get(
            job_seeker=job_seeker_1, professional=prescriber, prescriber_organization=None, company=None
        )
        ...
        assignment_1_employer = JobSeekerAssignment.objects.get(
            job_seeker=job_seeker_1, professional=employer, prescriber_organization=None, company=None
        )
        ...
        assignment_1_orga_1 = JobSeekerAssignment.objects.get(
            job_seeker=job_seeker_1, professional=prescriber, prescriber_organization=organization_1
        )
