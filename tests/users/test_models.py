...
from itou.asp.models import AllocationDuration, Commune, Country, EducationLevel
...
def test_job_seeker_profile_field_history(factory, field, value):
    ...
    # NOTE(cms): Tests crash if no parameter is passed.
    # Romain knows. ^_^
    with triggers.context(cache_buster=field):
