...
class TestManager:
    ...
    def test_linked_job_seeker_ids(self):
        ...
        # From the prescriber as no organization member
        ...
        # From the prescriber as the organization member
        ...
        # From the prescriber as another organization member. We won't display those
        JobSeekerFactory(
            created_by=prescriber,
