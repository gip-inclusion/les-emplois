...
class TestTransferUserData:
    ...
    def test_transfer_assignments(self, admin_client):
        ...
        # assignment with the same professional and organization: assignment_2 will be deleted and assignment_3 updated
        ...
        # another assignment with the same job_seeker, professional, company (None here), this is to check whether the
        # filters return only 1 result.
        JobSeekerAssignmentFactory(
            job_seeker=to_user,
            professional=assignment_2.professional,
            prescriber_organization=PrescriberOrganizationFactory(),
        ...
        # assignment with the same professional and company: assignment_4 will be deleted and assignment_5 updated
        ...
        assignment_5 = JobSeekerAssignmentFactory(
            job_seeker=to_user,
            professional=assignment_4.professional,
            company=assignment_4.company,
        )
        # another assignment with the same job_seeker, professional, prescriber_organization. This is to check whether
        # the filters return only 1 result.
        JobSeekerAssignmentFactory(
            job_seeker=to_user, professional=assignment_4.professional, company=CompanyFactory()
        )
