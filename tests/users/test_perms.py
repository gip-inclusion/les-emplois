...
class TestCanCreateSiaeAntenna:
    def test_siae_admin_can_create_siae_antenna(self):
        ...
        assert can_create_siae_antenna(user, company, is_company_admin=True) is True
    ...
    def test_siae_normal_member_cannot_create_siae_antenna(self):
        ...
        user = company.members.get()
        assert can_create_siae_antenna(user, company, is_company_admin=False) is False
    ...
    def test_siae_admin_without_convention_cannot_create_siae_antenna(self):
        ...
        user = company.members.get()
        assert can_create_siae_antenna(user, company, is_company_admin=True) is False
    ...
    def test_admin_ability_to_create_siae_antenna(self, kind):
        ...
        assert can_create_siae_antenna(user, company, is_company_admin=True) is expected
