...
def test_build_params_from(snapshot, caplog):
    ...
    assert APIParticulierClient._build_params_from(job_seeker) == snapshot(name="api_particulier_build_params")

    APIParticulierClient._build_params_from(job_seeker)
    # Missing parameters.
    ...
    params = APIParticulierClient._build_params_from(job_seeker)
