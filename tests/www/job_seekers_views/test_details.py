...
class TestLastKnownAdvisor:
    def test_display_last_known_advisor(self, client):
        ...
        prescriber_assignment = JobSeekerAssignmentFactory(
            ...
            updated_at=assignment.updated_at - datetime.timedelta(days=7),
        )
        ...
        prescriber_assignment.save(update_fields=["updated_at"])
            ...
            Context(
                {
                    ...
                    "has_access_to_assignments": True,
                }
            )
        )
...
class TestAdvisorsTab:
    ...
    def test_tab(self, client, snapshot):
        ...
        assignment = JobSeekerAssignmentFactory(
            ...
            updated_at=datetime.datetime(2026, 1, 3, 11, tzinfo=datetime.UTC),
        )
