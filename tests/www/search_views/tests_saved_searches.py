...
class TestSavedSearches:
    ...
    DISABLED_ADD_BUTTON_MARKUP = """
        ...
        <button type="button" data-bs-toggle="tooltip" data-bs-placement="top"
                data-bs-title="Le nombre maximum de recherches sauvegardées a été atteint.">
            <i class="ri-information-line ri-xl text-info ms-1"
               aria-label="Le nombre maximum de recherches sauvegardées a été atteint."></i>
        </button>
        """
    ...
    def test_add_saved_search_htmx_reload(self, client):
        ...
        # New saved search, with a limit of 1: the add button should be disable
