...
class TestSearchPrescriber:
    ...
    def test_results(self, client):
        ...
        assertContains(
            response,
            "<title>Prescripteurs habilités à 15 km du centre de Guérande (44) - La plateforme de l’inclusion</title>",
            html=True,
            count=1,
        )
    ...
    def test_form_invalid(self, client):
        ...
        assertContains(
            response,
            "<title>Rechercher des prescripteurs habilités - La plateforme de l’inclusion</title>",
            html=True,
            count=1,
        )
