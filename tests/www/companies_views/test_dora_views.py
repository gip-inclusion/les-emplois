...
def test_get_data_inclusion_services(settings, respx_mock):
    ...
    api_mock = respx_mock.get("https://fake.api.gouv.fr/v0/search/services")
    api_mock.respond(
        200,
        json={
...
def test_dora_service_redirect(client, settings, respx_mock):
    ...
    respx_mock.get("https://fake.api.gouv.fr/v0/services/dora/foo").respond(200, json={"id": "foo", "source": "dora"})
    ...
    respx_mock.get("https://fake.api.gouv.fr/v0/services/dora/foo").respond(500)
    response = client.get(url)
