...
@pytest.mark.parametrize(
    ...
    [
        "cd_hiring",
        "ddets_iae_ph_prescription",
        "ddets_iae_auto_prescription",
    ],
)
def test_stats_dgefp_iae_showroom_sends_department_code_to_metabase(client, mocker, dashboard_full_name):
    ...
    assert params[mb.DEPARTMENT_FILTER_KEY] == ["69"]
