...
_SUSPENDED_APPROVAL_PRESCRIBER_TOOLTIP = (
    "Le PASS IAE est valide, en pause entre deux contrats. Vous pouvez orienter cet usager sans restriction."
)
_SUSPENDED_APPROVAL_EMPLOYER_TOOLTIP = (
    "Vous pouvez embaucher cet usager. "
...
def test_list_for_siae_select_applications_batch_accept(client, snapshot, company_kwargs):
    ...
    # The "unacceptable" job application tooltip only works if the only unacceptable state is accepted.
