...
@freeze_time()
def test_step_3(client, snapshot, mocker, pdf_file):
    job_application = JobApplicationFactory(
        state=JobApplicationState.REFUSED,
        for_snapshot=True,
    ...
    assert new_job_application.resume_link == (
        ...
        "/resume/22222222-2222-2222-2222-222222222222.pdf"
    )
    assert new_job_application.resume.key == "resume/22222222-2222-2222-2222-222222222222.pdf"
...
def test_step_3_no_previous_CV(client, mocker, pdf_file):
    ...
    assert new_job_application.resume_id == "resume/11111111-1111-1111-1111-111111111111.pdf"
    assert new_job_application.state == JobApplicationState.NEW
