...
class TestMergeUsers:
    ...
    def test_merge_assignments(self, client, caplog):
        ...
        assignment_1 = JobSeekerAssignmentFactory(caseworker=prescriber_2)

        # JSA(job_seeker, from_user, None) ; JSA(job_seeker, to_user, None)
        # will get: JSA(job_seeker, to_user, None)
        assignment_2 = JobSeekerAssignmentFactory(caseworker=prescriber_2, last_action_kind=ActionKind.IAE_ELIGIBILITY)
        ...
        assignment_3_to_user = JobSeekerAssignmentFactory(
            caseworker=prescriber_1, last_action_kind=ActionKind.GEIQ_ELIGIBILITY
        )
