    ...
    assert rows == [
        {
            ...
            "type_inscription": "par professionnel",
            "pe_connect": 1,
            "pe_inscrit": 0,
            ...
            "critère_n2_travailleur_handicapé_date_certification": None,
            "critère_n2_travailleur_handicapé_période_certification": None,
        ...
        },
        {
            ...
            "total_embauches": 1,
            "total_diagnostics": 1,
            "date_diagnostic": timezone.localdate(job_application_2.eligibility_diagnosis.created_at),
        ...
        },
        {
            ...
            "total_embauches": 2,
            "total_diagnostics": 2,
            "date_diagnostic": timezone.localdate(job_application_3.eligibility_diagnosis.created_at),
    ...
    with connection.cursor() as cursor:
        ...
        assert rows == [
            (
                ...
                False,  # archived_at
                False,  # auto rerused
                timezone.localdate(ja.created_at),
                ja.hiring_start_at,
                timezone.localdate(ja.processed_at),
    ...
    assert rows == [
        {
            ...
            "date_de_création": timezone.localdate(prolongation.created_at),
...
def test_populate_prolongation_requests(snapshot):
    ...
    assert rows[0] == {
        ...
        "date_de_demande": timezone.localdate(prolongation_request.created_at),
