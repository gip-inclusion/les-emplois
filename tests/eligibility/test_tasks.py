...
from itou.eligibility.tasks import async_certify_criterion_by_api_particulier, certify_criterion_by_api_particulier
...
class TestCertifyCriteriaApiParticulier:
    ...
    def test_queue_task(self, criteria_kind, factory, respx_mock):
        ...
        async_certify_criterion_by_api_particulier.call_local(criterion._meta.model_name, criterion.pk)
    ...
    def test_no_retries_when_criterion_does_not_exist(self, caplog, factory):
        ...
        async_certify_criterion_by_api_particulier.call_local(modelname, 0)
