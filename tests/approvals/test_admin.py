...
class TestProlongationDerogation:
    ...
    def test_button_hidden_when_prolongation_is_impossible(self, client):
    ...
    def test_no_link_before_submission(self, admin_client):
    ...
    def test_company_not_subject_to_iae_rules(self, admin_client):
        ...
        assertContains(response, "Cette entreprise n’est pas une SIAE, elle ne peut pas déclarer de prolongation.")
        assert not PkSupportRemark.objects.exists()
