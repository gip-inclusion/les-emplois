...
class TestOrientationAPI:
        ...
        assert response.json()["results"] == [
            {
                ...
                "status": "VALIDÉE",
                "beneficiary_name": "Alix ABÉ",
                "france_travail_id": "1234567C",
                "service_uid": "service-uid-accepted-orientation",
                "sender_organization_name": "France Travail - Arles",
                "sender_name": "Alexis ACÉ",
                "process_link": accepted_orientation.process_links.first().process_link,
            },
            {
                "created_at": "2026-08-01T02:00:00+02:00",
                "status": "EXPIRÉE",
                "beneficiary_name": "Bob BOBARD",
                "france_travail_id": None,
                "service_uid": "service-uid-expired-orientation",
                "sender_organization_name": "France Travail - Brest",
                "sender_name": "Brice BUBBLE",
                "process_link": expired_orientation.process_links.first().process_link,
            },
            {
                "created_at": "2026-09-01T02:00:00+02:00",
                "status": "REFUSÉE",
                "beneficiary_name": "Charly CHA",
                "france_travail_id": None,
                "service_uid": "service-uid-refused-orientation",
                "sender_organization_name": "Compas nie",
                "sender_name": "Chris CROUTCH",
                "process_link": refused_orientation.process_links.first().process_link,
            },
        ]

    def test_generate_process_link_only_for_current_page(self):
        api_client = self.api_client()
    ...
    def test_bad_input(self):
        ...
        response = api_client.post(self.url, data={"structure_uid": ""})
