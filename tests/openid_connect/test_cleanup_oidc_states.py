...
def test_cleanup(caplog):
    ...
    pe_recent = FranceTravailConnectState.objects.create(state="pe_recent")
    ...
    FranceTravailConnectState.objects.create(state="pe_old", created_at=cutoff)
    ...
    for model, expected in (
        ...
        (FranceTravailConnectState, [pe_recent]),
    ...
    assert caplog.messages[:-1] == [
        ...
        "Deleted 1 obsolete FranceTravailConnectState",
