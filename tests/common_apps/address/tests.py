...
class TestFormatAddressOnOneLine:
    ...
    def test_without_address_line_2(self):
        obj = SimpleNamespace(
            address_line_1="12 rue des terreaux",
            address_line_2="",
            post_code="38110",
    ...
    @pytest.mark.parametrize("empty_attribute", ["address_line_1", "post_code", "city"])
    def test_incomplete_returns_none(self, empty_attribute):
        obj = SimpleNamespace(
            address_line_1="12 rue des terreaux",
            address_line_2="Bât. B",
            post_code="38110",
