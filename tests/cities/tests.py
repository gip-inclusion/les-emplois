...
def test_sync_cities(settings, caplog, respx_mock):
    ...
    assert caplog.messages[:-1] == [
        ...
        "\tREMOVED Guérande (44)",
        "Removed location from=0 JobDescription due to city deletion",
        "Removed insee_city from=0 Company due to city deletion",
        "Removed insee_city from=0 PrescriberOrganization due to city deletion",
        "Removed insee_city from=0 User due to city deletion",
        "Removed insee_city from=0 Institution due to city deletion",
...
def test_sync_cities_with_refill(settings, caplog, respx_mock):
    ...
    assert caplog.messages[:-1] == [
        ...
        "\tREMOVED Guérande (44)",
        "Removed location from=1 JobDescription due to city deletion",
        "Removed insee_city from=0 Company due to city deletion",
        "Removed insee_city from=0 PrescriberOrganization due to city deletion",
        "Removed insee_city from=1 User due to city deletion",
        "Removed insee_city from=0 Institution due to city deletion",
