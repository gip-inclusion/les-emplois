...
class TestDropDownStatus:
    ...
    def test_mvp_enabled_prescriber(self):
        user = PrescriberFactory()
        assert dropdown_status(user=user)["mvp-enabled"] is False
        assert dropdown_status(email=user.email)["mvp-enabled"] is False
        ...
        assert dropdown_status(user=user)["mvp-enabled"] is True
        assert dropdown_status(email=user.email)["mvp-enabled"] is True
