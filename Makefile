...
prepare_cc_secrets:
	# Merge secrets
	echo '' > envs/base64/cc.env
	cat envs/secrets.env >> envs/base64/cc.env
	cat envs/cc.env >> envs/base64/cc.env
	# Convert into Base64 files
	base64 envs/base64/cc.env  | tr -d \\n > envs/base64/cc_encrypted.env
