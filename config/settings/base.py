...
API_ESD = {
    "AUTH_BASE_URL_AGENT": os.getenv("API_ESD_AUTH_BASE_URL_AGENT"),
...
# TODO: Drop this Mailjet fallback when all emails sent by Mailjet are purged
# from the database (circa December 2026).
